...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    //Blotter
    Route::get('/blotter', 'BlotterController@index')->name('blotter.index');
    Route::get('/blotter/create', 'BlotterController@create')->name('blotter.create');
    Route::post('/blotter', 'BlotterController@store')->name('blotter.store');
    Route::get('/blotter/{blotter}/edit', 'BlotterController@edit')->name('blotter.edit');
    Route::put('/blotter/{blotter}', 'BlotterController@update')->name('blotter.update');
    Route::delete('/blotter/{blotter}', 'BlotterController@destroy')->name('blotter.destroy');
