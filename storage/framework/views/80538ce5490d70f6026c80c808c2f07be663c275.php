...
<?php $__env->startSection('sub-title','MANAGE DOCUMENTS'); ?>
  ...
  <section id="team" class="team mt-5 section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Tracker</h2>
          <p>Track your service request</p>
        </div>
        <div class="row">
          <div class="col-12">
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-uppercase font-weight-bold">REQUESTED SERVICE INFORMATION</h5>
...
<?php echo $__env->make('../layouts.resident', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\brgypembo\resources\views/resident/requested/requested.blade.php ENDPATH**/ ?>