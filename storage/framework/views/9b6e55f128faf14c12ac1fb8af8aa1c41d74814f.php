...
<?php $__env->startSection('sub-title','FINDER RESIDENT'); ?>
                        ...
                        <div class="form-group">
                          <select name="select_resident" id="select_resident" class="form-control select2" style="width: 100%;">
                            ...
                            <?php $__currentLoopData = $residents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($resident->id); ?>" <?php echo e($resident1->id == $resident->id ? 'selected' : ''); ?>><?php echo e($resident->last_name); ?>,<?php echo e($resident->first_name); ?> (<?php echo e($resident->middle_name ?? 'n/a'); ?>)</option>
                ...
                <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <button id="<?php echo e($resident1->id); ?>" class="btn btn-primary btn-sm view" >
                              VIEW/EDIT
                            </button>
                          </div>
                        </div>
                      ...
                      <td>
                            <div class="d-flex px-2 py-1">
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="/resident/img/id/<?php echo e($resident1->id_image); ?>" target="_blank">
                                        <img style="vertical-align: bottom;"  height="100" width="100" src="<?php echo e(URL::asset('/resident/img/id/'.$resident1->id_image)); ?>" />
                                    </a>
                                </div>
                            </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident1->first_name ?? ''); ?> <?php echo e($resident1->last_name ?? ''); ?>  (<?php echo e($resident1->middle_name ?? 'n/a'); ?>)</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident1->user->email ?? ''); ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident1->contact_number ?? ''); ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident1->address ?? ''); ?></h6>
                          </div>
                        </div>
                      </td>
                      <td  class="align-middle text-center text-sm">
                          <span class="badge badge-sm 
                            <?php if($resident->status == 'PENDING'): ?>
                              bg-warning
                            <?php elseif($resident->status == 'APPROVED'): ?>
                              bg-success
                            <?php elseif($resident->status == 'DECLINED'): ?>
                              bg-warning
                            <?php elseif($resident->status == 'DEACTIVATED'): ?>
                              bg-danger
                            <?php endif; ?>">
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident1->created_at->format('M j , Y h:i A') ?? ''); ?></h6>
          ...
          <div class="card-body ">
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  <?php $__currentLoopData = $requested_documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <button id="<?php echo e($document->id); ?>" class="btn btn-primary btn-sm view_edit" >
                              VIEW/EDIT
                            </button>
                          </div>
                        </div>
...
<?php echo $__env->make('../layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Swaggy\Desktop\brgypembo\resources\views/admin/finder_resident.blade.php ENDPATH**/ ?>