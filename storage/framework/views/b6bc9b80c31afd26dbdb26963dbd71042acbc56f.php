...
Pembo is a residential and commercial area and is second to the largest in the district in terms of population. Based on the 2010 Census of Population conducted by the National Statistics Office, Pembo has a total of 44,803 population and percentage share of 2.34% versus the city’s population with an estimate of at least 8,961 households. By population density on the other hand, considering  its land area and population count, the barangay has 70 per 1,000 square meters</p>
								...
								<div class="col-md-6">
									<img class="img-fluid rounded shadow " src="<?php echo e(asset('website2/images/company/pembo-1.jpg')); ?>" alt="">
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="mission" role="tabpanel" aria-labelledby="profile-tab">
							<div class="row">
								...
								<div class="col-md-6">
									<img class="img-fluid rounded shadow mt-20" src="<?php echo e(asset('website2/images/company/pem.jpg')); ?>" alt="">
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="vision" role="tabpanel" aria-labelledby="contact-tab">
							<div class="row">
								...
								<div class="col-md-6">
									<img class="img-fluid rounded shadow mt-20" src="<?php echo e(asset('website2/images/company/municipal.jpg')); ?>" alt="">
								</div>
							</div>
						</div>
					</div>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr data-title="<?php echo e($announcement->title); ?>" data-content="<?php echo e($announcement->content); ?>">
            ...
            <div class="d-flex justify-content-end">
                <?php echo e($announcements->links('layouts.pagination')); ?>
            ...
            <div class="col-lg-3 mt-2" data-aos="fade-up" data-aos-delay="200">
              <div class="box featured">
                ...
                <div class="text-center mb-0">
                  <a href="/resident/request_document/<?php echo e($document->id); ?>" class="buy-btn mx-auto">Request Now</a>
                </div>
...
<div class="page-wrapper">
  ...
  <div class="post-media post-thumb">
    <a href="blog-single.html">
      <img src="<?php echo e(asset('website/images/blog/blog-post-1.jpg')); ?>" alt="">
    </a>
  </div>
...
<div class="post">
  <div class="post-media post-thumb">
    <a href="blog-single.html">
      <img src="<?php echo e(asset('website/images/blog/blog-post-2.jpg')); ?>" alt="">
    </a>
  </div>
...
<div class="post">
  <div class="post-media post-thumb">
    <a href="blog-single.html">
      <img src="<?php echo e(asset('website/images/blog/blog-post-3.jpg')); ?>" alt="">
    </a>
  </div>
...
<?php echo $__env->make('../layouts.resident', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Swaggy\Desktop\brgypembo\resources\views/resident/home.blade.php ENDPATH**/ ?>