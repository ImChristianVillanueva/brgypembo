                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <div class="d-flex px-2 py-1 align-items-center">
                        ...
                        <div class="ms-4">
                          ...
                          <h6 class="text-sm mb-0 text-uppercase">
                            <?php echo e($pending->resident->last_name ?? ''); ?> ,
                            <?php echo e($pending->resident->first_name ?? ''); ?>

                            (<?php echo e($pending->resident->middle_name ?? ''); ?>)
                    ...
                    <td>
                        ...
                        <h6 class="text-sm mb-0 text-uppercase"><?php echo e($pending->document->name ?? ''); ?></h6>
                     
                    </td>
                    <td>
                        <p class="text-xs font-weight-bold mb-0">Claiming Option:</p>
                        <h6 class="text-sm mb-0 text-uppercase"><?php echo e($pending->claiming_option ?? ''); ?></h6>
                     
                    </td>
                    <td class="align-middle text-sm">
                        <div class="d-flex">
                          <a href="/admin/finder_resident/<?php echo e($pending->resident->id); ?>" class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></a>
                        </div>
                    </td>
                  </tr>
                  ...
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm text-uppercase"><?php echo e($document->name); ?></h6>
                        <span class="text-xs"><?php echo e($document->requested_requirements->count()); ?> Residents have made a request.</span>
                      </div>
                    </div>
                    <div class="d-flex">
...
<?php echo $__env->make('../layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Swaggy\Desktop\brgypembo\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>