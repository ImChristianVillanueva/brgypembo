...
<?php $__env->startSection('sub-title','ACCOUNT'); ?>
    ...
    <div class="container">
        ...
        <div class="row mt-2">
          <div class="col-lg-10 mt-lg-0 mx-auto" data-aos="fade-left">
                    <?php if(auth()->user()->resident->isRegister == 0): ?>
                    
                    <?php else: ?>
                        <?php if(auth()->user()->resident->status == 'PENDING'): ?>
                        ...
                        <?php elseif(auth()->user()->resident->status == 'DECLINED'): ?>
                        ...
                        <?php elseif(auth()->user()->resident->status == 'DEACTIVATED'): ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control" readonly value="<?php echo e(Auth()->user()->email ?? ''); ?>">
                                </div> 
                            </div>
                            <div class="col-md-6">
                            <label>Upload ID Here <span class="text-danger">*</span> <a href="#"  id="list_ids">Acceptable Valid IDs</a></label>
                                <div class="picture-container">
                                    <div class="form-group">
                                        ...
                                        <div class="picture">
                                            <img src="<?php if(Auth()->user()->resident->id_image != ''): ?> /resident/img/id/<?php echo e(Auth()->user()->resident->id_image); ?> <?php else: ?> <?php echo e(asset('/resident/img/id.jpg')); ?>  <?php endif; ?> " class="picture-src" id="wizardPicturePreview" title="" />
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input id="first_name" name="first_name" type="text" class="form-control" value="<?php echo e(Auth()->user()->resident->first_name ?? ''); ?>" autofocus>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input id="middle_name" name="middle_name" type="text" class="form-control" value="<?php echo e(Auth()->user()->resident->middle_name ?? ''); ?>">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input id="last_name" name="last_name" type="text" class="form-control" value="<?php echo e(Auth()->user()->resident->last_name ?? ''); ?>">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="address" name="address" type="text" class="form-control" value="<?php echo e(Auth()->user()->resident->address ?? ''); ?>">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="contact_number" name="contact_number" type="text" class="form-control" value="<?php echo e(Auth()->user()->resident->contact_number ?? ''); ?>">
                                    <span class="invalid-feedback" role="alert">
...
<?php echo $__env->make('../layouts.resident', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\brgypembo\resources\views/auth/account.blade.php ENDPATH**/ ?>