...
<?php $__env->startSection('sub-title','MANAGE RESIDENT'); ?>
                  ...
                  <?php $__currentLoopData = $residents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <button id="<?php echo e($resident->id); ?>" class="btn btn-primary btn-sm view" >
                              VIEW/EDIT
                            </button>
                          </div>
                        </div>
                      ...
                      <td>
                            <div class="d-flex px-2 py-1">
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="/resident/img/id/<?php echo e($resident->id_image); ?>" target="_blank">
                                        <img style="vertical-align: bottom;"  height="100" width="100" src="<?php echo e(URL::asset('/resident/img/id/'.$resident->id_image)); ?>" />
                                    </a>
                                </div>
                            </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident->first_name ?? ''); ?> <?php echo e($resident->last_name ?? ''); ?>  (<?php echo e($resident->middle_name ?? 'n/a'); ?>)</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident->user->email ?? ''); ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident->contact_number ?? ''); ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident->address ?? ''); ?></h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo e($resident->created_at->format('M j , Y h:i A') ?? ''); ?></h6>
...
<?php echo $__env->make('../layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Swaggy\Desktop\brgypembo\resources\views/admin/manage_residents.blade.php ENDPATH**/ ?>